...
using SelectEntryFunction = void (*)(const char* player_name, int playlist_index);
...
using SetPlayerVolumeFunction = void (*)(const char* player_name, float volume);
...
using PlayerVolumeChangedFunction = void (*)(const char* playerName, double volume);
